...
public class ProductoController {
	...
	// =================CREAR====================
	@RequestMapping("")
	public String index(@ModelAttribute("producto") Producto producto, Model model, HttpSession session) {
		if(session.getAttribute("usuarioId")!=null) {
			System.out.println("INDEX");
			List<Producto> lista_productos = ps.findAll();
			//Usuario usuario = us.buscarUsuario(Long.parseLong(session.getAttribute("usuarioId").toString()));
